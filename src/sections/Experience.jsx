...
const Experience = () => {
  ...
  return (
    <section
      id="experience"
      className="flex justify-center items-center md:mt-40 mt-20 px-5 md:px-10 md:mt-40 mt-20 xl:px-0"
    >
      <div className="w-full h-full md:px-20 px-5">
        <Title
          title="Tech Stack Learning & Timeline."
          sub="💼 My Career Learning Overview"
        />
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="expText flex xl:gap-20 md:gap-10 gap-5 relative z-20">
                        <div className="md:size-20 size-10 flex-none rounded-full flex justify-center items-center md:-translate-y-7 border border-[#1c1c21] bg-[#0e0e10]">
                          <img src={card.logoPath} className="w-[80%] rounded-full" alt="logo" />
                        </div>
                        <div>
