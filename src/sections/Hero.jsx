...
const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden mt-7">
      ...
      <div className="relative z-10 xl:mt-10 mt-24 md:h-dvh h-[80vh] flex xl:items-center items-start justify-center">
        ...
        <header className="flex flex-col justify-center md:w-full w-screen md:px-20 px-5">
          ...
          <div className="flex items-center mt-8 gap-7">
            <div className="md:px-5 md:py-4 px-3 py-2 bg-[#111111] rounded-lg flex items-center gap-3">
              Download CV{" "}
        ...
        <div className="xl:w-[50%] w-full h-[50vh] min-h-[40vh] absolute xl:top-40 top-70 xl:-right-70 -right-20">
          <div className="md:h-[50vh] md:w-[50vh] h-[35vh] w-[35vh] flex items-center rounded-full">
            <img
      ...
      <div className="w-full md:h-[16vh] h-auto md:absolute md:top-[80%] relative md:mt-13 mt-3 px-5 md:px-20 grid grid-cols-2 md:flex gap-5 justify-between">
        <div className="md:w-[20%] w-full flex items-center justify-center gap-6 px-6 py-4 rounded-lg text-white">
          <h2 className="text-4xl md:text-7xl font-bold">2</h2>
